...
document.addEventListener('DOMContentLoaded', () => {
  ...
  authForm.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      submitBtn.textContent = currentMode === 'login' ? 'Authenticating...' : 'Registering...';
      ...
      showToast(currentMode === 'login' ? 'Welcome back!' : 'Account registered successfully!');
      ...
      console.error(err);
      showToast('Network error connecting to the server.', 'error');
      submitBtn.disabled = false;
      submitBtn.textContent = currentMode === 'login' ? 'Log In' : 'Create Account';
    }
  });
